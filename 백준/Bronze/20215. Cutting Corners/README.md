...
<ul>
	<li>A line containing two integers $w$ and $h$ ($1\leq w,h\leq 100$), representing the width and height of the corner respectively.</li>
</ul>

### 출력 

 <p>Output how much longer you have to cut if you cut out a rectangle, compared to cutting along the diagonal. Your answer should have an absolute or relative error of at most $10^{-6}$.</p>
